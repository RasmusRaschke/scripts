...
\begin{proof}
	...
	\begin{figure}[H]
	\centering
	\include{./graphics/orbit_stabilizer.tex}
	\caption{\blue{Zu sehen ist eine Skizze der Überlegung für den Tetraeder: Wir lassen die alternierende Gruppe auf den nummerierten Ecken des Tetraeders wirken, dargestellt durch Drehungen um die eingezeichneten Symmetrieachsen. Betrachten wir z.B. die Achse durch Punkt $4$, so lässt die Identität, eine $120^\circ$- und eine $240^\circ$- Drehung den Tetraeder als solches invariant. Die $4$ wird von diesen drei Elementen stabilisiert. Betrachten wir nun die anderen drei Rotationsachsen, so sehen wir, dass die $4$ auf jedes andere Element rotiert wird, also besteht ihre Bahn aus vier Elementen.}}
	\end{figure}
