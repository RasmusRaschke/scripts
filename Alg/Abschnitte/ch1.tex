...
\end{beweis}
Damit bezeichnen wir die Menge der Linksnebenklassen von $H$ mit $\quotient{G}{H} = \quotient{G}{\sim_L}$ und die der Rechtsnebenklassen mit $\quotient{G}{H} = \quotient{G}{\sim_R}$ \textcolor{red}{Hier Quotient umdrehen!}.
...
\end{definition}
Man beachte, dass $\left| \quotient{H}{G} \right| = \left| \quotient{H}{G} \right|$ [\textcolor{red}{Hier auch Quotient umdrehen!}] gilt, da die Abbildung $\dots$.
...
\end{enumerate}
\end{beweis}
\begin{satz}{Homomorphiesatz (erster Isomorphisatz)}{homomorphisatz}
