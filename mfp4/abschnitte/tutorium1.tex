...
\begin{tikzpicture}[scale=3]
	...
	\draw (.5cm,0) arc [start angle=0, end angle=40, radius=.5cm];
	\draw (20:2mm) \node[red] {$\phi$};
	\draw[red] (40:1cm) -- node[right=1pt] {$\sin \phi$} (40:1cm |- 0,0);
	\draw[blue] (0,0) -- node[below=10pt] {$\cos \phi$} (40:1cm |- 0,0);
	\draw[green] (0,0) -- node[above=10pt] {$\tan \phi$}  (40:1cm);
\end{tikzpicture}
\end{figure}
